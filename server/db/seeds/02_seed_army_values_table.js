...
exports.seed = async function(knex) {
  await knex('army_values').insert([
    ...
    {name: 'Brotherhood Apothecary', class: 'Elites', unit_size: '1'},
    {name: 'Brotherhood Ancient', class: 'Elites', unit_size: '1'},
    {name: 'Dreadnought', class: 'Elites', unit_size: '1'},
    {name: 'Paladin Ancient', class: 'Elites', unit_size: '1'},
    {name: 'Paladin Squad', class: 'Elites', unit_size: '3-10'},
    {name: 'Purifier Squad', class: 'Elites', unit_size: '5-10'},
    {name: 'Servitors', class: 'Elites', unit_size: '4'},
    ...
    {name: 'Purgation Squad', class: 'Heavy Support', unit_size: '1'},
